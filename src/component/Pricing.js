          ...
          <Row>
                ...
                <Card className="border-0 shadow">
                  <div className="p-4 border-bottom border-light">
                    ...
                    <p className="text-muted mb-0">
                      For individuals looking for a simple Startups solution
                    </p>
                    ...
                    <div className="d-flex my-4">
                      ...
                      <span className="text-muted align-self-end mb-1">
                        /mo
                      </span>
                    </div>
                  ...
                  <div className="p-4">
                    ...
                    <ul className="mb-0 list-unstyled">
                      {item.features.map((subitem, subkey) => (
                        <li className="text-muted " key={subkey}>
                          <span
                            className={
                              item.price < 90 && subkey > 2
                                ? "text-danger h5 me-1"
                                : " text-success h5 me-1"
                            }
                          >
                            <i
                              className={
                                item.price < 90 && subkey > 2
                                  ? "uil uil-times-circle align-middle"
                                  : " uil uil-check-circle align-middle"
                              }
                            ></i>
                          </span>{" "}
                          {subitem}
            ...
            <div className="col text-center mt-2">
              <p className="mt-3 mb-0 text-muted">
                Note: <span className="text-danger fs-5">*</span>No credit card
                required
              </p>
            </div>
          </Row>
